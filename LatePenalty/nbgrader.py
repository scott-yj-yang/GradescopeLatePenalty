# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/01_nbgrader_process_grade.ipynb.

# %% auto 0
__all__ = ['bcolors', 'nbgrader_grade']

# %% ../nbs/api/01_nbgrader_process_grade.ipynb 3
import canvasapi
...
# %% ../nbs/api/01_nbgrader_process_grade.ipynb 4
class bcolors:
    HEADER = '\033[95m'
    OKBLUE = '\033[94m'
    OKCYAN = '\033[96m'
...
# %% ../nbs/api/01_nbgrader_process_grade.ipynb 5
