# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/00_process_grade.ipynb.

# %% auto 0
__all__ = ['bcolors', 'process_grade']

# %% ../nbs/api/00_process_grade.ipynb 3
import canvasapi
...
# %% ../nbs/api/00_process_grade.ipynb 4
class bcolors:
    HEADER = '\033[95m'
    OKBLUE = '\033[94m'
    OKCYAN = '\033[96m'
...
# %% ../nbs/api/00_process_grade.ipynb 5
class process_grade:
    def __init__(self,
